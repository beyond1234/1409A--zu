...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
    <meta charset="UTF-8">
        <title>企业租车|商务租车|价格 - 大方租车,中国互联网租车领跑者</title>
        <meta name="description" content="大方租车-中国互联网租车领跑者，连锁租车行业NO.1。企业租车预订频道为您提供大量企业用车，商务用车,车型,价格,企业租车，商务用车,就上大方租车.客服热线400-0600-112.">
        <meta name="keywords" content="企业租车,商务租车,企业租车价格,商务租车价格">
    <link type="text/css" rel="stylesheet" href="../resources/assets/home/public/all.css">
    <link type="text/css" rel="stylesheet" href="../resources/assets/home/public/company.css">
...
<div class="slide">
    ...
    <div class="bd">
        <ul class="img">
                <li class="active"><a style="background: url(/Content/Upload/Ad/20160118074816860.jpg) no-repeat top center" target="_blank"></a></li>
                <li class=""><a style="background: url(/Content/Upload/Ad/20160118074851173.jpg) no-repeat top center" target="_blank"></a></li>
        </ul>
    </div>
    <!--索引-->
    <div class="hd">
        <ul class="tit">
        <li class="active"></li><li class="last_tit"></li></ul>
    </div>
</div>
<!--内容-->
<div class="box1">

    <div class="box1_title">企业租车优势</div>
    <div class="box1_c1">
        <div class="box1_img1"><img src="../resources/assets/home/public/car.png"></div>
        <div class="box1_c1_1">用车便捷</div>
        <div class="box1_c1_2">时需时用<br>车型多选。不再烦恼<br>折旧保险、保养<br>维修等问题</div>
    </div>
    <div class="box1_c2">
        <div class="box1_img1"><img src="../resources/assets/home/public/bookshelf.png"></div>
        <div class="box1_c1_1">24小时服务</div>
        <div class="box1_c1_2">专业团队24小时服务<br>有任何问题只需拨打<br>400电话即有专人配合解决</div>
    </div>
    <div class="box1_c2">
        <div class="box1_img1"><img src="../resources/assets/home/public/rocket.png"></div>
        <div class="box1_c1_1">方式灵活</div>
        <div class="box1_c1_2">时租、半日租、日租<br>周租、月租、年租、以租代购<br>多种方式满足不同需求<br>将节省成本最大化</div>
    </div>
    <div class="box1_c2">
        <div class="box1_img1"><img src="../resources/assets/home/public/chair.png"></div>
        <div class="box1_c1_1">定制服务</div>
        <div class="box1_c1_2">大方租车将根据企业自身<br>的用车情况及业务特点<br>制定专属用车方案<br>最大程度减少成本支出</div>
    </div>
</div>
<div class="img2"></div>
<div class="img3">
    <div class="box2">
        <div class="box2_title">服务项目</div>
        <div class="box3">
            <div class="box3_1">租车服务</div>
            <div class="box3_img1"><img src="../resources/assets/home/public/box3_img1.png"></div>
            <div class="box3_2">时租</div>
            <div class="box3_3">半日租</div>
            <div class="box3_4">日租</div>
            <div class="box3_5">周租</div>
            <div class="box3_6">月租</div>
        </div>
        <div class="box4">
            <div class="box3_1">接送服务</div>
            <div class="box4_img1"><img src="../resources/assets/home/public/box3_img2.png"></div>
            <div class="box4_2">机场接送</div>
            <div class="box4_3">会议接送</div>
            <div class="box4_3">城际接送</div>
...
<div class="box5">
    <div class="box5_title">以租代购</div>
    <div class="box5_wz">
        大方租车跨越整个租车周期的全方位服务，让您轻松用车。更有“专人专项”给您提供保姆式服务，为您贴心指导更降低保养成本<br>租间内您的生活登上新台阶需要高级别车型时，更有“车辆升级”帮您解决后顾之忧<br>大方如此“操心”，只为帮您解决用车中的所有细节问题<br>选择大方以租代购，选择轻松购车体验。
    </div>
    <div class="box5_img1">
        <img src="../resources/assets/home/public/1.jpg">
        <div class="box5_img1_1">价格低</div>
        <div class="box5_img1_2">厂家直销<br>售价低于齐场<br>同类价格</div>

    </div>
    <div class="box5_img2">
        <img src="../resources/assets/home/public/2.jpg">
        <div class="box5_img1_1">提车快</div>
        <div class="box5_img1_2">当天办理<br>当天提车</div>
    </div>
    <div class="box5_img2">
        <img src="../resources/assets/home/public/3.jpg">
        <div class="box5_img1_1">首付少</div>
        <div class="box5_img1_2">首付10%起<br>租期12-36个月<br>提前付清享优惠</div>
    </div>
    <div class="box5_img2">
        <img src="../resources/assets/home/public/4.jpg">
        <div class="box5_img1_1">门槛低</div>
        <div class="box5_img1_2">无抵押<br>无担保<br>无户口限制</div>
    </div>
    <div class="box5_img2">
        <img src="../resources/assets/home/public/5.jpg">
        <div class="box5_img1_1">服务全</div>
        <div class="box5_img1_2">全程保姆式服务<br>原厂质保<br>7天可退，30天可升级<br>车辆升级</div>
    </div>
    <div class="box5_img2">
        <img src="../resources/assets/home/public/6.jpg">
        <div class="box5_img1_1">选择多</div>
        <div class="box5_img1_2">新车、二手车<br>皆可办理</div>
    </div>
</div>
    <!--底部-->
<div class="footer">
...
<div style="display: none;"><form action="http://lxbjs.baidu.com/vt/lxb.gif" method="post" target="lxbHideIframe"><input name="p" value=""><input name="sid" value="6567291"><input name="bdcbid" value="7d79330e-43ae-4404-b97b-c68977d8c319"><input name="t" value="1472609026480"></form><iframe id="lxbHideIframe" name="lxbHideIframe" src="../resources/assets/home/public/a.htm"></iframe></div></body></html>