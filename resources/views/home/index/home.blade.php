    ...
    <div class="top_box">
        ...
        <ul class="top_menu">
            <li class="top_user">
                ...
                <?php }else{?>
                    欢迎<span style="color:#ff0000"><?php echo Session::get('name')?></span>
